...
const dictionaries = {
  en: {
    ...
    contest: {
      eyebrow: "Film contest",
      title: "We started a film photo contest",
      text: "A new round every week, with a small prize we ship worldwide.",
      cta: "Enter now",
      close: "Dismiss",
    },
  },
  ...
  ru: {
    ...
    contest: {
      eyebrow: "Плёночный конкурс",
      title: "Мы запустили конкурс плёночных фото",
      text:
        "Новый раунд каждую неделю и небольшой приз с доставкой по всему миру.",
      cta: "Участвовать",
      close: "Закрыть",
    },
  },
  es: {
    ...
    contest: {
      eyebrow: "Concurso analógico",
      title: "Tenemos un concurso de fotografía analógica",
      text:
        "Una ronda nueva cada semana y un pequeño premio que enviamos a todo el mundo.",
      cta: "Participar",
      close: "Cerrar",
    },
  },
  fr: {
    ...
    contest: {
      eyebrow: "Concours argentique",
      title: "Nous lançons un concours photo argentique",
      text:
        "Une édition chaque semaine et un petit cadeau envoyé partout dans le monde.",
      cta: "Participer",
      close: "Fermer",
    },
  },
  it: {
    ...
    contest: {
      eyebrow: "Concorso analogico",
      title: "Abbiamo aperto un concorso di fotografia analogica",
      text:
        "Un turno nuovo ogni settimana e un piccolo premio spedito in tutto il mondo.",
      cta: "Partecipa",
      close: "Chiudi",
    },
  },
  vi: {
    ...
    contest: {
      eyebrow: "Cuộc thi ảnh phim",
      title: "Chúng tôi vừa mở một cuộc thi ảnh phim",
      text: "Mỗi tuần một vòng mới, kèm một phần quà nhỏ gửi đi khắp thế giới.",
      cta: "Tham gia",
      close: "Đóng",
    },
  },
  id: {
    ...
    contest: {
      eyebrow: "Kontes film analog",
      title: "Kami membuka kontes foto film",
      text:
        "Ronde baru setiap minggu dan hadiah kecil yang kami kirim ke seluruh dunia.",
      cta: "Ikut serta",
      close: "Tutup",
    },
  },
  ja: {
    ...
    contest: {
      eyebrow: "フィルムコンテスト",
      title: "フィルム写真のコンテストを始めました",
      text: "毎週開催で、ささやかな賞品を世界中どこへでもお送りします。",
      cta: "見てみる",
      close: "閉じる",
    },
  },
  hi: {
    ...
    contest: {
      eyebrow: "फ़िल्म प्रतियोगिता",
      title: "हमने एक फ़िल्म फ़ोटो प्रतियोगिता शुरू की है",
      text:
        "हर हफ़्ते नया राउंड और एक छोटा इनाम, जो दुनिया में कहीं भी भेजा जाता है।",
      cta: "देखें",
      close: "बंद करें",
    },
  },
  el: {
    ...
    contest: {
      eyebrow: "Διαγωνισμός φιλμ",
      title: "Ξεκινήσαμε διαγωνισμό φωτογραφίας με φιλμ",
      text:
        "Νέος γύρος κάθε εβδομάδα και ένα μικρό δώρο που στέλνουμε σε όλο τον κόσμο.",
      cta: "Συμμετοχή",
      close: "Κλείσιμο",
    },
  },
  ko: {
    ...
    contest: {
      eyebrow: "필름 콘테스트",
      title: "필름 사진 콘테스트를 시작했어요",
      text: "매주 새 라운드가 열리고, 작은 선물을 전 세계로 보내드립니다.",
      cta: "참여하기",
      close: "닫기",
    },
  },
  uk: {
    ...
    contest: {
      eyebrow: "Плівковий конкурс",
      title: "Ми запустили конкурс плівкових фото",
      text:
        "Новий раунд щотижня та невеликий приз із доставкою в будь-яку точку світу.",
      cta: "Взяти участь",
      close: "Закрити",
    },
  },
  ar: {
    ...
    contest: {
      eyebrow: "مسابقة التصوير بالفيلم",
      title: "أطلقنا مسابقة للتصوير بالفيلم",
      text: "جولة جديدة كل أسبوع وجائزة صغيرة تُشحن إلى أي مكان في العالم.",
      cta: "شارك الآن",
      close: "إغلاق",
    },
  },
  he: {
    ...
    contest: {
      eyebrow: "תחרות צילום פילם",
      title: "פתחנו תחרות צילום בפילם",
      text: "סבב חדש בכל שבוע ופרס קטן שנשלח לכל מקום בעולם.",
      cta: "להשתתף",
      close: "סגירה",
    },
  },
